...
public class VoltageCl0 {
    ...
    public static final String BACKUP = "/data/.hK3475/cpuCl0_stock_voltage";

    public static final String CL0_VOLTAGE = "/sys/devices/system/cpu/cpufreq/exynos-cpufreq/volt_table";
